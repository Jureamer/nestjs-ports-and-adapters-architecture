...
export class GetLastMessageByChatRoomIdRepository implements GetLastMessageByChatRoomIdPort {
    async execute(
        ...
        const found = this.mockData.find(({ chatRoomId }) => chatRoomId === params.chatRoomId);
